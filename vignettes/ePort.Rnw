...
This short report contains a table that provides an overview of student performance. as seen in Figure \ref{fig:outputShort}.


\begin{center}
\captionof{figure}{Overview of report generation}
\label{fig:outputShort}
\fbox{\includegraphics{outputShort.png}}
\end{center}
