...
<<eval=FALSE>>=
system.file("extdata", package = "ePort")
@
...
<<eval=FALSE>>=
dir.create(file.path(system.file("extdata", package = "ePort"), "OutputFiles"))
@
...
loPath = system.file("extdata/LOFiles/Topic06.Outcomes.txt", package = "ePort")

outPath = system.file("extdata/OutputFiles", package = "ePort")
...
<<eval=FALSE>>=
dataFolder = system.file("extdata/DataFiles/Topic06", package = "ePort")
...
<<eval=FALSE>>=
dataFolder = system.file("extdata/DataFiles/Topic06_07_08", package="ePort")
...
<<eval=FALSE>>=
dataFolder = system.file("extdata/DataFiles/Chapter20_Split", package = "ePort")
dataList = list.files(path = dataFolder, full.names = TRUE)[1:3]
...
<<eval=FALSE>>=
dataFolder = system.file("extdata/DataFiles/Topic11_Merge", package="ePort")
...
dataListPath = c(system.file("extdata/DataFiles/Topic06/Topic06.A.csv",
  package = "ePort"), system.file("extdata/DataFiles/Topic06/Topic06.B.csv",
  package = "ePort"), system.file("extdata/DataFiles/Topic06/Topic06.C.csv",
  package = "ePort"))
@
...
<<eval=FALSE>>=
unlink(paste0(system.file("extdata/OutputFiles", package = "ePort"), "/*"))
@
