...
<<eval=FALSE>>=
report_routine(key_txt,datafile=datapath,rewrite=FALSE,LOfile=LOpath,knitfile=system.file("inst/Rnw/", "hw-individual-short.Rnw", package="ePort"),knito=system.file("inst/extdata/ReportFiles", package="ePort"))
@
