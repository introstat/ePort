...
report_routine(key_txt,datapath,rewrite=FALSE,LOfile=LOpath,knitfile="~/Dropbox/NSF Grant 2013-2015/Reports/Code/ePort/inst/Rnw/hw-individual-short.Rnw",knito="~/Dropbox/NSF Grant 2013-2015/Reports/Code/ePort/inst")
```

- Run a full report

```{r indi-report-full, eval=FALSE}
report_routine(key_txt,datapath,rewrite=FALSE,LOfile=LOpath,knitfile="~/Dropbox/NSF Grant 2013-2015/Reports/Code/ePort/inst/Rnw/hw-individual.Rnw",knito="~/Dropbox/NSF Grant 2013-2015/Reports/Code/ePort/inst")
```
...
for (i in namelist) report_routine(key_txt,datafile=i,rewrite=FALSE,LOfile=LOpath,knitfile="~/Dropbox/NSF Grant 2013-2015/Reports/Code/ePort/inst/Rnw/hw-individual-short.Rnw",knito="~/Dropbox/NSF Grant 2013-2015/Reports/Code/ePort/inst")
```

- Run the full reports in batches (by loop)

```{r indi-report-full-batch, eval=FALSE}
for (i in namelist) report_routine(key_txt,datafile=i,rewrite=FALSE,LOfile=LOpath,knitfile="~/Dropbox/NSF Grant 2013-2015/Reports/Code/ePort/inst/Rnw/hw-individual.Rnw",knito="~/Dropbox/NSF Grant 2013-2015/Reports/Code/ePort/inst")
```
