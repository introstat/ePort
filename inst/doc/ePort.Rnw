...
1 Put information about title key
2 Put example LO
3 Put example topics
...
\begin{tabular} { | l | l | }
\hline \textbf{Topic Number} & \textbf{Description} \\
\hline
01 & Data \\
\hline
