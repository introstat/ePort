...
#cat("\\noindent",chapter_outcomes,sep="\\bigskip{} \n\n")
#cat("\\\\ \n ~~ \n")

for (i in 1:length(chapter_outcomes)){
      cat("\\noindent", chapter_outcomes[i], "\n\n")
      cat("\\vspace{4mm}")
}
@
...
<<lmeQQNorm, echo=FALSE, fig.env = "figure", out.width = "0.98\\linewidth", fig.align = "center", fig.cap = "QQ-plot of the residuals by the generalized mixed effects model",fig.lp = "fig:">>=
