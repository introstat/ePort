...
SplitCSSore=wideTableLatex(CSScorewithSpace,tablecaption='Sorted learning objective sets and total correct percentages',label='tab:LearningObj_data',cols=10)

CSRank = round(100 - apply(CSScore,2,rank,ties.method='max')/nrow(CSScore)*100,2)
PrintCSRank=wideTableLatex(CSRank,tablecaption='Rank of the students by the total and learning objective scores. The percentages are the proportion of students in this section who got a higher score in the corresponding column.',label='tab:LearningObj_rank',cols=10)
