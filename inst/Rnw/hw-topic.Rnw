...
print(xtable(tmplag,caption='Students whose scores were under 20\\% of the class.',
             label='tab:lag'), floating=FALSE, tabular.environment = "longtable",
