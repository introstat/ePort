...
print(qplot(value,name,data=fixedcoef_plot,geom=c('point'),size=1,color=name,xlab="",ylab="")+geom_vline(xintercept=0,color=I(1))+geom_line(size=I(2.5))+scale_colour_hue(h=c(52,320))+theme(legend.position="NA", axis.text=element_text(size=25),axis.title=element_text(size=25)))
@
