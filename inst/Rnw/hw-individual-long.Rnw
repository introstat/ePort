...
print(qplot(TotalScore,data=sumry1,geom='histogram',binwidth=1,main='',xlim=c(0,sumry1$FullScore[1]), na.rm = TRUE) + theme(axis.text=element_text(size=20),axis.title=element_text(size=20)))
@
