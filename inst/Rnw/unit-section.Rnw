...
print(qplot(LearningObj, Percent, data=b, geom='boxplot',fill=Section) + labs(x="Learning Outcome", y="Percentage Correct") + theme(axis.text.x=element_text(size=15), axis.text.y=element_text(size=15)) )
{dev.off();invisible()}
