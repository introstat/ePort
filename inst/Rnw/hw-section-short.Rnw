...
print(qplot(Section,Score,data=sectionscore,geom='boxplot',fill=Section)+theme(legend.position = "none",axis.text=element_text(size=27),axis.title=element_text(size=27)) )
{dev.off();invisible()}
cat(sprintf('
\\begin{marginfigure}
...
<<echo=FALSE,results='asis'>>=
cat("\\marginnote{\n\n \\bigskip{} \n\n \\bigskip{} \n\n} ")
cat(c("\\marginnote{Learning outcomes in this topic:",
